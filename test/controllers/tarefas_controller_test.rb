...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { DataPrazo: @tarefa.DataPrazo, Descricao: @tarefa.Descricao, Nome: @tarefa.Nome, Prioridade: @tarefa.Prioridade } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { DataPrazo: @tarefa.DataPrazo, Descricao: @tarefa.Descricao, Nome: @tarefa.Nome, Prioridade: @tarefa.Prioridade } }
